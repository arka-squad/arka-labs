    ...
    >
        ...
        <header className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2" style={{ color: 'var(--site-muted)' }}>
              Une squad où chaque rôle est clair…
            </p>
          </div>
          <div className="hidden md:flex items-center gap-2">
            ...
            <button
              ...
              className="h-11 w-11 rounded-full bg-white ring-1 ring-black/10 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              ◀
            </button>
            <button
              ...
              disabled={atEnd}
              onClick={() => snapTo(Math.min(data.length - 1, active + 1))}
              className="h-11 w-11 rounded-full bg-white ring-1 ring-black/10 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              ▶
            </button>
      ...
      <div className="mt-6 w-screen relative left-1/2 right-1/2 -mx-[50vw]">
        <div
          ...
          style={{
            ['--rail-pad' as any]: railPad,
            paddingLeft: 'var(--rail-pad)',
            paddingRight: 'var(--rail-pad)',
            ...
            >
              <div className="relative overflow-hidden rounded-t-[16px] bg-slate-100 h-28 md:h-36 lg:h-44 xl:h-48">
                <img
                  ...
                  decoding="async"
                  onError={() =>
                    uiLog('landing.slider.agents.image_error', { id: a.id })
                  }
                />
              </div>
      ...
      <div className="mt-4 flex items-center justify-center gap-3 hidden">
        ...
        <span className="ml-2 text-sm" style={{ color: 'var(--site-muted)' }}>
