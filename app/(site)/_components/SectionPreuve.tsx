    ...
    <section aria-labelledby="preuve" className="py-16">
      <div className="mx-auto max-w-[1440px] px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        <div className="md:col-span-6">
          <h2 id="preuve" className="text-3xl md:text-4xl font-semibold" style={{ color: 'var(--site-text)' }}>C’est quoi une « preuve »</h2>
          ...
          <ul className="mt-4 text-sm space-y-1" style={{ color: 'var(--site-text)' }}>
        ...
        <div className="md:col-span-6">
          <article className="rounded-[20px] bg-white ring-1 ring-black/5 shadow-[0_12px_30px_rgba(15,23,42,.08)] p-6">
            <h3 className="text-base font-semibold" style={{ color: 'var(--site-text)' }}>Paquet Evidence</h3>
            <p className="mt-2 text-sm" style={{ color: 'var(--site-muted)' }}>evidence.zip
