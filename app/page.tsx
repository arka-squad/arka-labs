      ...
      <section id="console" className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-slate-400 mb-6">
            Arka R1 réunit en une seule interface trois briques essentielles : <b>Prompt Builder</b>, <b>gestion documentaire</b> et{' '}
            <b>observabilité en temps réel</b>. Cette intégration unique fait d'Arka une console multi-agents prête à l'emploi. Idéal pour des
            petites équipes qui veulent livrer plus vite, avec plus de rigueur et un niveau de qualité supérieur.
          </p>
