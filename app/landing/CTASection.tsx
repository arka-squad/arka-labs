...
export default function CTASection() {
  return (
    <section id="cta" className="mx-auto mt-24 max-w-4xl px-6 text-center text-slate-300">
      ...
      <h2 className="mt-4 text-2xl font-semibold text-white">Inscrivez-vous à la bêta</h2>
      <a
        href="/console"
        className="mt-6 inline-block rounded-full px-6 py-3 text-sm font-medium text-white shadow-lg"
