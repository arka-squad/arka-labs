...
const ASSETS = {
  ...
  SCREENSHOT_CONSOLE: assetUrl('/assets/hero/console-demo.gif'),
    ...
    <div className="min-h-screen text-white font-[Poppins]" style={{ backgroundColor: TOKENS.bgBody }}>
      ...
      <section id="team" className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-slate-400 mb-6">Arka n’a pas vocation à remplacer des ERP lourds. Elle est volontairement <b>légère</b>, rapide à mettre en place et orientée <b>valeur immédiate</b>. Cible idéale : équipes de 2 à 30 personnes, qui veulent renforcer leurs capacités sans recruter massivement.</p>
